...
class test_suit_gp_sanity_settings_case14(TestCaseBase):
    '''
...
#             phone.permission_allow()                  
        ...
        if wait_for_fun(lambda:search_text("5.00 GB"), True, 5):
            log_test_framework("gp_sanity_settings_case14:", "case pass")
            case_flag = True
        elif search_text("stopped", searchFlag=TEXT_CONTAINS):
            log_test_framework("gp_sanity_settings_case14:", "Popup has stopped")
            take_screenshot()
            if search_text("OK"):
            ...
            log_test_framework("gp_sanity_settings_case14:", "case fail")        
