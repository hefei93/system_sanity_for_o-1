...
class test_suit_gp_sanity_settings_case16(TestCaseBase):
    '''
...
#             phone.permission_allow()                  
        ...
        if wait_for_fun(lambda:search_text("Off"), True, 5):
            log_test_framework("gp_sanity_settings_case15:", "case pass")
            case_flag = True
        elif search_text("stopped", searchFlag=TEXT_CONTAINS):
            log_test_framework("gp_sanity_settings_case15:", "Popup has stopped")
            take_screenshot()
            if search_text("OK"):
            ...
            log_test_framework("gp_sanity_settings_case15:", "case fail")        
