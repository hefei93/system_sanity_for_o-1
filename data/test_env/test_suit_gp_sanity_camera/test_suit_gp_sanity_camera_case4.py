...
class test_suit_gp_sanity_camera_case4(TestCaseBase):
    '''
...
#             click_textview_by_text('OK')
        if wait_for_fun(lambda:search_view_by_id('scene_mode_switcher'), True, 10):
            ...
            if search_text('AUTO') == False:
                log_test_framework("gp_sanity_camera_case4:", "Switch HDR pass")
                ...
                log_test_framework("gp_sanity_camera_case4:", "Switch HDR then camera has stopped")
                take_screenshot()
                click_textview_by_text('OK')
                sleep(2)
        elif search_text('has stopped'):
            log_test_framework("gp_sanity_camera_case4:", "Camera has stopped")
            take_screenshot()
            click_textview_by_text('OK')
            sleep(2)        
                ...
                sleep(5)
                click_textview_by_text("OK")
                log_test_framework("gp_sanity_camera_case4:", "ANR")
        else:
            log_test_framework("gp_sanity_camera_case4:", "Take HDR photo fail")
        send_key(KEY_BACK)        
        sleep(1)
        send_key(KEY_BACK)
        sleep(1)
