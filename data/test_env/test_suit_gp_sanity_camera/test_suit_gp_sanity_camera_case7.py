...
class test_suit_gp_sanity_camera_case7(TestCaseBase):
    '''
...
#             click_textview_by_text('OK')
        if wait_for_fun(lambda:search_view_by_id('front_back_switcher'), True, 10):
            ...
            if search_view_by_id('shutter_button'):
                log_test_framework("gp_sanity_camera_case7:", "Switch front camera pass")
                click_button_by_id('shutter_button')
                if wait_for_fun(lambda:search_view_by_id('remaining_photos_text'), True, 10):
                    log_test_framework("gp_sanity_camera_case7:", "Front camera take photo pass")            
                    case_flag = True
                elif search_text('has stopped'):
                    log_test_framework("gp_sanity_camera_case7:", "Front camera take photo then camera has stopped")
                    take_screenshot()
                    click_textview_by_text('OK')
                    sleep(2)
            elif search_text('has stopped'):
                log_test_framework("gp_sanity_camea_case7:", "Switch front camera then camera has stopped")
                take_screenshot()
                click_textview_by_text('OK')
                sleep(2)
        elif search_text('has stopped'):
            log_test_framework("gp_sanity_camera_case7:", "Camera has stopped")
            take_screenshot()
            click_textview_by_text('OK')
            sleep(2)        
                ...
                sleep(5)
                click_textview_by_text("OK")
                log_test_framework("gp_sanity_camera_case7:", "ANR")
        else:
            log_test_framework("gp_sanity_camera_case7:", "Front camera take photo fail")
        click_imageview_by_id('front_back_switcher')
        sleep(5)
        send_key(KEY_BACK)       
        sleep(1)
