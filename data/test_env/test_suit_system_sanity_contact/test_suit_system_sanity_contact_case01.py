...
class test_suit_system_sanity_contact_case01(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        def execute():  
            ...
            if search_text("Next",isScrollable=0):
                send_key(KEY_BACK)
                sleep(3)
            if wait_for_fun(lambda:search_text("ALL"), True, 5) or search_text("ADD NEW ACCOUNT")or search_text("Contacts", searchFlag=TEXT_CONTAINS):
        ...
        case_flag = repeat_cmcc_devci(execute,5)
