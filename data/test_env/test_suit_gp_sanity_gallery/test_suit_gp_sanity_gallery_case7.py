...
class test_suit_gp_sanity_gallery_case7(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        if wait_for_fun(lambda:search_text("WALLPAPERS"), True, 5):
                ...
                if wait_for_fun(lambda:search_view_by_id("set_wallpaper_button"), True, 5):
                    ...
                    if wait_for_fun(lambda:search_text("Home screen"), True, 5):
                        ...
                        if wait_for_fun(lambda:search_view_by_desc("Apps"), True, 6):
                            log_test_framework("gp_sanity_gallery_case7:", "set wallpaper successfully")
                            case_flag = True       
        elif search_text('has stopped'):
            log_test_framework("gp_sanity_gallery_case7:", "Popup has stopped")
            take_screenshot()
            ...
            sleep(5)
            click_textview_by_text("OK")
            log_test_framework("gp_sanity_gallery_case7:", "ANR")
        else:
            log_test_framework("gp_sanity_gallery_case7:", "case fail")
