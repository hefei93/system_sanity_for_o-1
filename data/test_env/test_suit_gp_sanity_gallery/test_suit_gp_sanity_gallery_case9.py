...
class test_suit_gp_sanity_gallery_case9(TestCaseBase):
    '''
...
#             phone.permission_allow()
        ...
        if search_text('stopped')==False:            
            log_test_framework("gp_sanity_gallery_case9:", "case pass")
            case_flag = True       
        elif search_text('has stopped'):
            log_test_framework("gp_sanity_gallery_case9:", "Popup has stopped")
            take_screenshot()
            click_textview_by_text('OK')
            sleep(2)
        else:
            log_test_framework("gp_sanity_gallery_case9:", "case fail")
