...
class test_suit_gp_sanity_gallery_case8(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        if wait_for_fun(lambda:search_text("Snapdragon Gallery"), True, 5):
            log_test_framework("gp_sanity_gallery_case8:", "set wallpaper successfully")
            case_flag = True       
        elif search_text('has stopped'):
            log_test_framework("gp_sanity_gallery_case8:", "Popup has stopped")
            take_screenshot()
            ...
            sleep(2)
                ...
                sleep(5)
                click_textview_by_text("OK")
                log_test_framework("gp_sanity_gallery_case8:", "ANR")
        else:
            log_test_framework("gp_sanity_gallery_case8:", "case fail")
