...
#        
#        fs_wrapper.run_init_settings = True
#        test_suit = test_loader.loadTestSuitFromName("settings.test_suit_settings", "test_suit_settings")
#        suit_results = []
#        test_suit.test_suit_run(suit_results)
#        fs_wrapper.run_init_settings = False
...
#                     for i in range(1):
#                         fs_wrapper.run_init_settings = True
#                         test_suit_settings = test_loader.loadTestSuitFromName("settings.test_suit_settings", "test_suit_settings")
#                         suit_results_settings = []
#                         test_suit_settings.test_suit_run(suit_results_settings)
#                         fs_wrapper.run_init_settings = False
