...
class test_suit_system_sanity_message_case02(TestCaseBase):
    '''

    @see: L{TestCaseBase <TestCaseBase>}
    "Procedure:
    Step1:set default sending message is sim card 1 
    Step2:Launch message
    Step3:send a picture 
    Verification: 
    ER1:can send picture message successfully
    '''
