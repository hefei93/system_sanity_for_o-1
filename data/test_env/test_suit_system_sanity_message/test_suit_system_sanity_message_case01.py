...
class test_suit_system_sanity_message_case01(TestCaseBase):
    '''

    @see: L{TestCaseBase <TestCaseBase>}
    "Procedure:
    Step1:Launch dial
    Step2:from dial history send message
    Verification: 
    ER1:can send message successfully
    '''
...
#         settings.set_default_voice(1)
        ...
        start_activity("com.android.dialer", ".app.DialtactsActivity")
        ...
        if wait_for_fun(lambda:search_view_by_id("embedded_text_editor"), True, 60):
            ...
            sleep(1)
            os.system('adb shell input text value')
            sleep(3)
