...
class test_suit_gp_sanity_gallery_case10(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        if wait_for_fun(lambda:search_view_by_desc("Apps"), True, 5):            
            log_test_framework("gp_sanity_gallery_case10:", "case pass")
            case_flag = True       
        elif search_text('has stopped'):
            log_test_framework("gp_sanity_gallery_case10:", "Popup has stopped")
            take_screenshot()
            click_textview_by_text('OK')
            sleep(2)
        else:
            log_test_framework("gp_sanity_gallery_case10:", "case fail")
