...
class test_suit_system_sanity_camera_case11(TestCaseBase):
    '''
    ...
    step2.switch to take picture mode
    step3.random set HDR is enable or disable
    Step4:in random mode take photo
    Step5:repeat step3 and step4
    Verification: 
    ER4:no crash in random mode
    '''
