...
class test_suit_system_sanity_camera_case14(TestCaseBase):
    '''
    ...
    step2.Take snapshot with random feature
    Verification: 
    ER4: Camcorder feature set correct without crash or ANR
    '''
    ...
    def test_case_main(self, case_results):
        ...
        if wait_for_fun(lambda:search_view_by_id('shutter_button'), True, 5):
            ...
            switchCR('Record')
            setRecord('Second')
            result.append(recording_video(10))
            setRecord('First')
            result.append(recording_video(10))
