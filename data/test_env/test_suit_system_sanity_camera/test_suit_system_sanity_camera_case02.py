...
class test_suit_system_sanity_camera_case02(TestCaseBase):
    '''
    ...
    Step3: repeat step2 for 20 time
    Verification: 
    ER2:No crash,No ANR   
    '''
    ...
    def test_case_main(self, case_results):
        ...
        global case_flag , TAG, testresult, success_flag, i, success_time,recoreName,p 
        ...
        fail_time = 0
        iterationNum = 20
        TAG = "repeat to launch camera By press home: Camera "
        ...
        for i in range(iterationNum):
            ...
            success_flag = False
            if wait_for_fun(lambda:search_view_by_id('shutter_button'), True, 15):
