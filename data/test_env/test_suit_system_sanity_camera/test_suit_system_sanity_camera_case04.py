...
class test_suit_system_sanity_camera_case04(TestCaseBase):
    '''
    ...
    Step2:Switch to Video Record;
    Step3:Switch to camera to picture mode;
    Step4:Repeat step2 and step3 for 20 time;
    Verification: 
    ER4:No exception;    
    '''
    ...
    def test_case_main(self, case_results):
        ...
        global case_flag , TAG, testresult, success_flag, i, success_time, record_flag, picture_flag,recoreName,p 
        case_flag = False
        ...
        fail_time = 0
        iterationNum = 20       
        TAG = "Switch between camera and camcorder for several times: Camera "
