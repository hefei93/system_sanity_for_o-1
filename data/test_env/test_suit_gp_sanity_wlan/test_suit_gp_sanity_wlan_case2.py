...
class test_suit_gp_sanity_wlan_case2(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        if search_text('WLAN'):
            ...
            if wait_for_fun(lambda:search_text('Hydra'), True, 60):
                ...
                if wait_for_fun(lambda:search_text('Connected'), True, 60):
                    log_test_framework("gp_sanity_browser_case2:", "Connect wlan pass")
                    case_flag = True
            ...
            log_test_framework("gp_sanity_browser_case2:", "Connect wlan fail") 
            take_screenshot()     
