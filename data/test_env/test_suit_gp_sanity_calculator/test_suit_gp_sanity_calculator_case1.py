...
class test_suit_gp_sanity_calculator_case1(TestCaseBase):
    '''
    ...
    def test_case_main(self, case_results):
        ...
        def execute():    
            ...
            if search_view_by_id('del'):
                log_test_framework("gp_sanity_calculator_case1:", "Launch calculator pass")
                send_key(KEY_BACK)
                send_key(KEY_BACK)
                send_key(KEY_HOME)
                if wait_for_fun(lambda:search_view_by_desc("Apps list"), True, 3):
                    log_test_framework("gp_sanity_calculator_case1:", "Exit pass")
                    case_flag = True
